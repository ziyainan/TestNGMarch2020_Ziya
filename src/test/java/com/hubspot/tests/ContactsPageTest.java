...
public class ContactsPageTest {
	...
	@DataProvider() // CONNECTION bu @DataProvider() keyword ikle saglanir
	public Object[][] getContactData(){
		Object data[][] = ExcelUtil.getTestData("contact");// exel deki sheet ismi
		return data;
	}
	@Test(priority=2, dataProvider="getContactData") // data provider bilgiyi nerden aldigimizi gosterir

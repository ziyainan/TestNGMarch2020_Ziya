...
public class BasePage {
	...
	public WebDriver initialize_driver(Properties prop){
		...
		if(browser.equalsIgnoreCase("chrome")){
		    System.setProperty("webdriver.chrome.driver", "/Users/zia/Documents/Drivers/chromedriver");
	...
	public Properties initialize_properties(){
		...
		try {
			FileInputStream ip = new FileInputStream("/Users/zia/Documents/workspace/FebruaryTestNG_2020_3/"

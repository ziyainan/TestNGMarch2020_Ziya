...
public class HomePage extends BasePage{
	...
	// BURAYA IKI FARKLI LOCATOR KOYARAK HOME --> CONTACT ILISKISI KURACAGIZ
...
public String verifyLoggedInAccountName(){
	...
	//helper metod
private void ClickOnContacts(){ // private helper method, User dan data gizleriz, sadece sonuc gosterecegiz
	// data yi private sakla , public ile cagiririz
	elementUtil.doClick(contactMainTab);
	elementUtil.doClick(contactChildTab);
}

public ContactsPage gotoContactsPage(){ // SSSS sorunu hallettim
	ClickOnContacts();
